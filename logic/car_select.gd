...
func _load_scene(car):
	...
	tt.set_name("car")
	town = load("res://scenes/town_scene.tscn").instance()
...
func _on_MiniVan_pressed():
	_load_scene("res://scenes/car_base.tscn")


func _on_TrailerTruck_pressed():
	_load_scene("res://scenes/trailer_truck.tscn")


func _on_TowTruck_pressed():
	_load_scene("res://scenes/tow_truck.tscn")
