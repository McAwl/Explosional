...
var types = {
	"Tank":		{"scene": "res://scenes/vehicle_tank.tscn", 
				...
				"wheel_friction_slip": 15.0, "wheel_roll_influence": 0.9,
				"brake": 20.0}, 
	"Racer": 	{"scene": "res://scenes/vehicle_racer.tscn", 
				...
				"wheel_friction_slip": 1.1, "wheel_roll_influence": 0.9,
				"brake": 10.0}, 
	"Rally": 	{"scene": "res://scenes/vehicle_rally.tscn", 
				...
				"all_wheel_drive": true,
				"wheel_friction_slip": 1.3, "wheel_roll_influence": 0.9,
				"brake": 5.0}, 
	"Truck": 	{"scene": "res://scenes/vehicle_truck.tscn", 
				...
				"all_wheel_drive": false,
				"wheel_friction_slip":1.0, "wheel_roll_influence": 0.5,
				"brake": 20.0}}
