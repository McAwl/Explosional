...
const DAMAGE = {"mine": 2, "rocket": 5, "missile": 5, "nuke": 10}
const DAMAGE_INDIRECT = {"mine": 1, "rocket": 1, "missile": 1, "nuke": 10}
...
const TARGET_SPEED = {"rocket": 10.0, "missile": 10.0}
const MUZZLE_SPEED = {"rocket": 10.0, "missile": 10.0}
