...
const SCENE: Dictionary = {
	Type.MINE: "res://scenes/explosive.tscn", \
	Type.ROCKET: "res://scenes/missile.tscn", \
	Type.MISSILE: "res://scenes/missile.tscn", \
	Type.NUKE: "res://scenes/explosive.tscn",
	Type.BALLISTIC: "res://scenes/missile.tscn"}
